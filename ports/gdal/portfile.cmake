...
set(GDAL_VERSION_STR "3.0.2")
set(GDAL_VERSION_PKG "302")
set(GDAL_VERSION_LIB "204")
set(GDAL_PACKAGE_SUM "3fdf8ece113bb475c7c9a9c22a88963f5581d69ec84eb307b7cfe11c17dab05ab6681d5c7463ba433b8f2013e889c5a0438aafd6c66a174b756fbdc7e09a5ea5")
...
#endif()
list(APPEND GDAL_PATCHES 0005-Fix-cfitsio.patch)
...
file(REMOVE_RECURSE ${CURRENT_PACKAGES_DIR}/share/${PORT}/vcpkg-cmake-wrapper.cmake)
file(RENAME ${CURRENT_PACKAGES_DIR}/lib/gdal_i.lib ${CURRENT_PACKAGES_DIR}/lib/gdal.lib)

# "fix" debug libs by overwriting them with release
file(REMOVE_RECURSE ${CURRENT_PACKAGES_DIR}/debug/lib/gdal_i.lib)
file(COPY ${CURRENT_PACKAGES_DIR}/lib/gdal.lib DESTINATION ${CURRENT_PACKAGES_DIR}/debug/lib)
file(RENAME ${CURRENT_PACKAGES_DIR}/debug/lib/gdal.lib ${CURRENT_PACKAGES_DIR}/debug/lib/gdald.lib)
file(REMOVE_RECURSE ${CURRENT_PACKAGES_DIR}/debug/bin/gdal300.dll)
file(COPY ${CURRENT_PACKAGES_DIR}/bin/gdal300.dll DESTINATION ${CURRENT_PACKAGES_DIR}/debug/bin)
#file(COPY ${CURRENT_PACKAGES_DIR}/bin/proj.dll DESTINATION ${CURRENT_PACKAGES_DIR}/debug/bin)
